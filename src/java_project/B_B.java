...
public class B_B {
	...
	public void bgm() {
        ...
        bgm = new File("c:/Users/SR/Desktop/java/java_project/src/BGM/music.wav");
		...
		static class MyPanel extends JPanel { //VANVAS for Draw!
			...
			private void drawUI(Graphics2D g2d) {
				...
				for(int i=0; i<BLOCK_ROWS; i++) {
					...
					g2d.setFont(new Font("DungGeunMo", Font.BOLD, 15));
	...
	public static void main(String[] args) {
         ...
         while(true) {
                try {
                      bgm.bgm();
                      Thread.sleep(23000); // 2분 30초에 한번씩 재생하도록 설정
                } catch(Exception e) {
